...
// of navigating away to a new tab. Handles its own Escape-to-close so any
// parent panel (e.g. a details drawer) doesn't need to coordinate which
// layer Escape should dismiss first.
