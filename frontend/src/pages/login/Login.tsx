      ...
      >
        <div className="text-center mb-8 sm:mb-10">
          ...
          <p className="text-slate-500 mt-3 text-base sm:text-lg">
            Sign in to continue to <span className="text-indigo-600 font-semibold">ChatApp</span>
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6 sm:space-y-8 max-w-2xl mx-auto">
          ...
          <div className="flex justify-start">
            <Link to="/signup" className="text-sm text-slate-500 hover:text-indigo-600 transition">
